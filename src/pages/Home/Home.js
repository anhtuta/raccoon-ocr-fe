      ...
      <div className="section-wrapper">
        <div className="header-section">
          <div className="products-details">
            ...
            <p>
              published by <span>Dũng Trần</span>
            </p>
        ...
        <div className="main-section">
          <div className="main-section-wrapper">
            ...
            {/* turn off transition because of this issue:
              https://github.com/react-bootstrap/react-bootstrap/issues/5075#issuecomment-616011685 */}
            <Tabs transition={false} defaultActiveKey="docsTab">
              <Tab eventKey="docsTab" title="Docs">
                <DocsTab />
              </Tab>
              <Tab eventKey="idTab" title="ID">
                <IdTab />
              </Tab>
            </Tabs>
          </div>
